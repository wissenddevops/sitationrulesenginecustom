...
define(
    ...
    function (
        ...
        return BaseSave.extend({
            ...
            configure: function () {
                //console.log(Routing.generate('sitation_testing'));
            ...
            updateImage: function(data, productId) {
                var routeUrl = Routing.generate('sitation_product_update_customise_image', { productId: productId })
                //var routeUrl = Routing.generate('sitation_customise_image');
                $.ajax({
                    url : routeUrl,
                    type: "POST",
